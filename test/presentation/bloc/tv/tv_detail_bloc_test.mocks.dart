...
import 'package:ditonton/domain/usecases/tv/get_recommendation_tvs.dart' as _i8;
...
class MockGetRecommendationTvs extends _i1.Mock
    implements _i8.GetRecommendationTvs {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i9.Tv>>> execute(int? tvId) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [tvId],
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveTvToWatchlist extends _i1.Mock implements _i11.SaveTvToWatchlist {
...
class MockRemoveTvFromWatchlist extends _i1.Mock
    implements _i12.RemoveTvFromWatchlist {
